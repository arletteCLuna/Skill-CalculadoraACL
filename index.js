...
const SumaIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        //const speakOutput = 'Calculadora Básica. El resultado de la suma de ${numero1} mas ${numero2} es igual a ${resultado}.';
        const speakOutput = `Calculadora Básica. El resultado de la suma de ${numero1} mas ${numero2} es igual a ${resultado}.`;
...
const PotenciacionIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = ` El resultado de ${numeroBase} elevado a la ${numeroExponente} es igual a ${resultado}.`;
...
const LogaritmoNaturalIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        var numeroEntrada = Number(numero);
        ...
        let resultado = Math.log(numeroEntrada);
        const speakOutput = `El logaritmo natural de ${numeroEntrada} es ${resultado.toFixed(4)}.`;
